 ...
 */
public class TaskFragment extends Fragment implements NamedFragment, SyncCallback {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		topLevelView = inflater.inflate(R.layout.frag_task, container, false);
	...
	private void generateFieldView(GetActionStatus getActionStatus) {
		...
		updateCustomTable(getActionStatus);
		//
		// if (fields == null) {
	...
	private void updateCustomTable(GetActionStatus getActionStatus) {

		// ((TextView)
		// topLevelView.findViewById(R.id.patientName)).setText(getActionStatus.getPatientName());
		// ((TextView)
		// topLevelView.findViewById(R.id.dateOfBirth)).setText(getActionStatus.getPatientBirthDate());
		// ((TextView)
		// topLevelView.findViewById(R.id.medicalRecordNumber)).setText(getActionStatus.getPatientMRN());
		// TextView textView = (TextView)
		// topLevelView.findViewById(R.id.isolation);
		...
		// ((TextView)
		// topLevelView.findViewById(R.id.type)).setText(getActionStatus.getClassName());
		// ((TextView)
		// topLevelView.findViewById(R.id.start)).setText(getActionStatus.getStartName());
		// ((TextView)
		// topLevelView.findViewById(R.id.destination)).setText(getActionStatus.getDestinationName());
		// ((TextView)
		// topLevelView.findViewById(R.id.mode)).setText(getActionStatus.getMode());
		// ((TextView)
		// topLevelView.findViewById(R.id.equipment)).setText(getActionStatus.getEquipmentId());
