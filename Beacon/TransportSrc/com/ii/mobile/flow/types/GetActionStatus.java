...
public class GetActionStatus extends GJon {
	...
	public class GetActionStatusInner {
		...
		public void init() {
			...
			// if (target.isolation == null)
			// target.isolation = new Isolation();
			...
			// L.out("target.patient: " + target.patient);
			// L.out("target.patient.birthDate: " + target.patient.birthDate);
			// target.patient.birthDate =
			// toDatePrettyLocal(target.patient.birthDate);
			// reverseDateOfBirth();
		}

		private void reverseDateOfBirth() {
			L.out("reverseDateOfBirth: " + targets.length);
			for (int i = 0; i < targets.length; i++) {
				Targets target = targets[i];
				if (target.patient != null) {
					L.out("start dob: " + target.patient.birthDate);
					String temp = reverseDOB(target.patient.birthDate);
					if (temp != null)
						target.patient.birthDate = temp;
					L.out("result dob: " + target.patient.birthDate);
				}
		...
		private String reverseDOB(String birthDate) {
			L.out("birthDate.): " + birthDate.indexOf("/"));
			// if (true)
			// return getTarget().patient.birthDate;

			if (birthDate.indexOf("/") != 4)
				return birthDate;
			...
			try {
				...
				L.out("date.getyear(): " + date.getYear());
				...
				Date test = targetFormat.parse(temp);
				L.out("date: " + date);

			} catch (ParseException e) {
				L.out("failed to reverseDOB: " + e);
			}
			return temp;
		}
	...
	public class Targets {
		...
		public String getPatientName() {
			...
			// // L.out("first and last: " + patient.firstName + " last: " +
			// // patient.lastName);
			// if (patient.firstName == null && patient.lastName == null)
			// return "";
			// if (patient.firstName == null || patient.firstName.equals(""))
			// return patient.lastName;
			// // L.out("patient.lastName:" + patient.lastName);
			// return patient.firstName + " " + patient.lastName;
		}
	}
	...
	class ActionStatus {
		...
		// private String printStatusHistory() {
		// String temp = "";
	...
	static public GetActionStatus getGJon(String json) {
		...
		// Targets target = getActionStatus.getTarget();
		// L.out("target.patient: " + target.patient);
		// L.out("target.patient.birthDate: " + target.patient.birthDate);
		// target.patient.birthDate =
		// getActionStatus.toDatePrettyLocal(target.patient.birthDate);
	...
	static protected GJon getJSonObjectArray(String json, Class<?> className) {
		...
		gsonBuilder.registerTypeAdapter(Targets[].class, new TargetsDeserializer());
	...
	// public boolean getBooleanIsolationPatient() {
	// // return getTarget().isolation.isolation;
	// String isolation = getTarget().isolation;
	// if (isolation != null && isolation.equals("Yes"))
	// return true;
	// return false;
	// }
	...
	// L.out("getBirthDatePretty: " + getTarget().patient.birthDate);
	// SimpleDateFormat originalFormat = new SimpleDateFormat("dd/MM/yyyy");
	// SimpleDateFormat targetFormat = new SimpleDateFormat("yyyy-mm-dd");
	// Date date;
	// String temp = "";
	// try {
	// date = originalFormat.parse(getTarget().patient.birthDate);
	// System.out.println("Old Format :   " + originalFormat.format(date));
	...
	public void setNamedValue(String header, String value) {
		...
		if (header.equals("txtPatientName")) {
			// L.out("header: #" + header + "#" + value);
			// remove null when fixed on flow
			// getTarget().patient.firstName = "";
			// getTarget().patient.lastName = value;
	...
	public void setActionStatusId(String actionStatusId, String optionId) {
		// if (getActionStatusInner.actionCache == null)
		// getActionStatusInner.actionCache = new ActionCache();
		// getActionStatusInner.actionCache.actionStatusId = actionStatusId;
	...
	// public void setCancelTypeId(String cancelTypeId) {
	// getTarget().cancelTypeId = cancelTypeId;
	// }
	//
	// public String getCancelTypeId() {
	// return getTarget().cancelTypeId;
	// }

	// public void setDelayTypeId(String delayTypeId) {
	// getTarget().delayTypeId = delayTypeId;
	// }
	//
	// public String getDelayTypeId() {
	// return getTarget().delayTypeId;
	// }
	...
	// public String toDatePretty() {
	// String temp = "";
	// try {
	// SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	// // sdf.setTimeZone(calendar.getTimeZone());
	// System.out.println("L.toDate: " + getTarget().patient.birthDate);
	// temp = sdf.format(getTarget().patient.birthDate);
	// } catch (Exception e) {
	// L.out("e: " + e);
	// }
	// return temp;
	...
	// public String toDatePretty() {
	// L.out("toDatePretty: " + getTarget().patient.birthDate);
	// // if (true)
	// // return getTarget().patient.birthDate;
	...
	// private String toDatePrettyLocal(String birthDate) {
	// L.out("toDatePretty: " + getTarget().patient.birthDate);
	// // if (true)
	// // return getTarget().patient.birthDate;
	// SimpleDateFormat targetFormat = new SimpleDateFormat("MM/dd/yyyy");
	...
	public void setLocalActionId(String localActionId) {
		L.out("localActionId: " + localActionId + " actionNumber: " + getActionNumber());
