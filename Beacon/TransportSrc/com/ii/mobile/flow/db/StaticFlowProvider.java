...
public final class StaticFlowProvider extends Persist {
	...
	public static final String AUTHORITY = "com.ii.mobile.beacon.flow";
	...
	//
	// StaticFlowProvider(Cursor c) {
	// flowMethod =
	// c.getString(c.getColumnIndexOrThrow(StaticFlowColumns.FLOW_METHOD));
	// json = c.getString(c.getColumnIndexOrThrow(StaticFlowColumns.JSON));
	// set_Id(c.getInt(c.getColumnIndexOrThrow(StaticFlowColumns._ID)));
	// }
