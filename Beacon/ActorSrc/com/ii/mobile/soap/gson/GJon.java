...
public class GJon extends Persist {
	...
	// public GJon(String employeeID, String facilityID, String taskNumber,
	// String json) {
	...
	// private static void debugOutput(GJon gJon) {
	// String temp = gJon.toString();
	// BaseSoap.debugOutput(temp);
	// }
