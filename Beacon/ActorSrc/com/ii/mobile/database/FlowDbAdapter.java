...
public class FlowDbAdapter extends AbstractDbAdapter {
	...
	// // String rowIda =
	// //
	// cursor.getString(cursor.getColumnIndexOrThrow(AbstractDbAdapter.KEY_ROWID));
	// // String timeStampa =
	// //
	...
	// String timeStamp =
	// cursor.getString(cursor.getColumnIndexOrThrow(AbstractDbAdapter.TIME_STAMP));
	// L.out("actionId: " + actionId + " rowId: " + rowId + " timeStampe: " +
	// timeStamp);
	//
	// }
	//
	...
	// cursor.moveToFirst();
	// String flowMethod =
	// cursor.getString(cursor.getColumnIndexOrThrow(StaticFlowColumns.FLOW_METHOD));
	// String json =
	// cursor.getString(cursor.getColumnIndexOrThrow(StaticFlowColumns.JSON));
	// // String timeStamp =
	// //
	// cursor.getString(cursor.getColumnIndexOrThrow(AbstractDbAdapter.TIME_STAMP));
	// String actionId =
	...
	// String actorId =
	// cursor.getString(cursor.getColumnIndexOrThrow(StaticFlowColumns.ACTOR_ID));
	// // String facilityID =
	// //
	// cursor.getString(cursor.getColumnIndexOrThrow(StaticFlowColumns.FACILITY_ID));
	// // L.out("rowId: " + rowId);
	// // L.out("timeStamp: " + timeStamp);
	// L.out("actionId: " + actionId + " flowMethod: " + flowMethod +
	// " actorId: " + actorId);
	// if (WANT_SECURITY) {
	// json = SecurityUtils.decryptAES(User.getUser().getPassword(), json);
